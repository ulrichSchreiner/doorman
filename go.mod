...
require (
	...
	github.com/smallstep/cli v0.18.1 // indirect
...
require (
	...
	github.com/smallstep/certificates v0.18.1 // indirect
	...
	go.step.sm/crypto v0.15.1 // indirect
	go.step.sm/linkedca v0.9.2 // indirect
